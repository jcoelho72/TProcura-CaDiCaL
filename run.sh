...
printf "\n\nRunning TProcura-CaDiCaL on the 'add' instances with varying parameters..." 
...
printf "\n\nRunning TProcura-CaDiCaL on the 'sat' instances with varying parameters..." 
./bin/Release/TProcura-CaDiCaL 0:13 -R Resultados/sat -G 1 -F cadical/test/cnf/sat -P P2=3 P3=1 P9=1 P3=1:4 x P9=1:4

printf "\n\nRunning TProcura-CaDiCaL on the 'sqrt' instances with varying parameters..." 
...
printf "\n\nRunning TProcura-CaDiCaL on the 'unit' instances with varying parameters..." 
